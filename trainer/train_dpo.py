...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="XLLM DPO (Direct Preference Optimization)"
    )
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="XLLM-DPO", help="wandb项目名"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"XLLM-DPO-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
        wandb.init(
