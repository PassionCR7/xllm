...
⭐ **本项目为个人学习复现项目，基于 minimind（https://github.com/jingyaogong/minimind）、MokioMind （https://github.com/Wood-Q/MokioMind）开源项目二次学习重构实现，完整复刻小参数 LLM 全链路训练、微调、强化学习、工具调用能力**
